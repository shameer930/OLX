...
const Mobile = () => {
  ...
  console.log(data.price,"uiuiuiuiihuiuuiui")
  return (
      ...
      <Swiper navigation={true} modules={[Navigation]} className="mySwiper">
        ...
        <SwiperSlide><img src={data.image5} alt="" /></SwiperSlide>
      </Swiper>
      </div>
      ...
      <div className=" mt-2 p-3 border border-1">
        ...
        <div class='row '>
          <div className="col-lg-4">
            <div class=" j7">
              <p class='pj'>Price</p>
              <p class='pj1'>{data.price}</p>
            </div>
            <div class=" j7">
              <p class='pj'>Bedrooms</p>
              <p class='pj1'>{data?.bedrooms}</p>
            </div>
            <div class=" j7">
              <p class='pj'>Bedrooms</p>
              <p class='pj1'>{data.bedrooms}</p>
            ...
            <div class=" j7">
              <p class='pj'>Bath Rooms</p>
              <p class='pj1'>{data.bathroom}</p>
            </div>
          </div>
