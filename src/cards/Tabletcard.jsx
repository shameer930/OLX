...
const Bikecard1 = () => {
  ...
  const filteredData=data?.filter((bikes)=>bikes.Category==="Tablet")
  return (
   <div className="m3">
    <div>
    <div class='d-flex'>
    <Link to="/Firstpage">  <span class='sp1'>Home</span ></Link>
      <span class='sp1'>/</span><span class='sp1'>Mobiles</span>
    </div>
    <h4 id='heading1'>Tablets in Pakistan</h4>
    </div>
       <div class='d-flex'>
        <div class="m7">
...
<div class='row'>
  <div className="col-lg-3 ">
    ...
    <div class="mt-3 m12">
     ...
     <div class=' m13'>
     <p>Mobile Phones(215438)</p>
      <p>Accessories(19647)</p>
      <p>Smart Watches(8373)</p>
      <p>Tablets(4625)</p>
     </div>
    </div>
    <div className="m7">
      ...
      <div class="m7">
      <p class='mt-3 m-lg-2 p15'>BRAND</p>
     <div class=' m13'>
      <p>Apple iPhone(77881)</p>
      <p>Samsung Mobile(26233)</p>
      <p>Vivo(17824)</p>
      <p>Infinix(16575)</p>
      <p>OPPO(14417)</p>
     </div>
     ...
     <div class=' m17 '>
      ...
      <span> <input type="checkbox" id='input2' /><p >Open Box(12272)</p></span>
      <span> <input type="checkbox" id='input2' /><p >For Parts or Not Working(1494)</p></span>
      <span> <input type="checkbox" id='input2' /><p >Refurbished(420)</p></span>
     </div>
     </div>
  </div>
  ...
  {filteredData?.map((item) => {
             ...
             return(
              <div class=' d-flex  mt-2 '>
               <div id='img0'>
               <Link to={`/Detailtablet/${item._id}`}><img src={item.image} alt="" width='320' height={220}/></Link>
               </div>
