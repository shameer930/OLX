...
const Bikecard1 = () => {
  ...
  const filteredData=data?.filter((bikes)=>bikes.Category==="Plot")
  return (
   <div className="m3">
    <div>
    <div class='d-flex'>
    <Link to="/Firstpage">  <span class='sp1'>Home</span ></Link>
      <span class='sp1'>/</span><span class='sp1'>Plots for Sale</span>
    </div>
    <h4 id='heading1'>Land & Plots for Sale</h4>
    </div>
       <div class='d-flex'>
        <div class="m7">
...
<div class='row'>
  <div className="col-lg-3 ">
    ...
    <div class="mt-3 m12">
     ...
     <p >All Categories</p>
     <p class='p11'>Plots for Sale</p>
     </div>
     <div class=' m13'>
      <p>Land & Plots(21834)</p>
      <p>Houses(14591)</p>
      <p>Apartments & Flats(4240)</p>
      <p>Shops - Offices - Commercial <br /> Space(1853)</p>
      <p>Portions & Floors(640)</p>
    ...
    <div className="m7">
      ...
      <div class="m7">
     <p class='mt-3 m-lg-2 p15'>AREA UNIT
     </p>
     <div class=' m17 '>
     <p >Kanal</p>
     <p >Marla</p>
     ...
     <div class="m7">
      <p class='mt-3 m-lg-2 p15'>FEATURES</p>
     <div class=' m13'>
     <span> <input type="checkbox" id='input2' /><p >Kitchen(645)</p></span>
     <span> <input type="checkbox" id='input2' /><p >Drawing Room(616)</p></span>
     <span> <input type="checkbox" id='input2' /><p >Dining Room(532)</p></span>
     <span> <input type="checkbox" id='input2' /><p >Lounge or Sitting Room(326)</p></span>
     <span> <input type="checkbox" id='input2' /><p >Store Room(305)</p></span>
     </div>
     </div>
     <div class="m7">
      <p class='mt-3 m-lg-2 p15'>TYPE</p>
     <div class=' m13'>
     <span> <input type="checkbox" id='input2' /><p >Residential Plots(18650)</p></span>
     <span> <input type="checkbox" id='input2' /><p >Commercial Plots(1505)</p></span>
     <span> <input type="checkbox" id='input2' /><p >Files(1304)</p></span>
     <span> <input type="checkbox" id='input2' /><p >Agricultural Land(249)</p></span>
     <span> <input type="checkbox" id='input2' /><p >Industrial Land(89)</p></span>
     </div>
     </div>
  </div>
  ...
  {filteredData?.map((item) => {
             ...
             return(
              <div class=' d-flex  mt-2 '>
               <div id='img0'>
               <Link to={`/Detailplot/${item._id}`}><img src={item.image} alt="" width='320' height={220}/></Link>
               </div>
