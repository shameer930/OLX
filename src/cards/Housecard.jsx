...
const Bikecard1 = () => {
  ...
  const filteredData = data?.filter((bikes) => bikes.Category === "House");
  ...
  return (
    <div className="m3">
      <div>
        ...
        <h4 id='heading1'>Houses for Sale</h4>
      </div>
      <div class='d-flex'>
        <div class="m7">
        ...
        <div className="col-lg-3 ">
          <div className="m7">
            <div class="mt-3 m12">
              ...
              <p>All Categories</p>
              <p class='p11'>Property for Sale</p>
            </div>
            <div class=' m13'>
              <p>Land & Plots(21825)</p>
              <p>Houses(14576)</p>
              <p>Others(10088)</p>
              <p>Apartments & Flats(4256)</p>
              <p>Shops - Offices - Commercial <br />Space(1856)</p>
              ...
              {filteredData?.map((item) => {
                return (
                  <div class=' d-flex  mt-2 '>
                    <div id='img0'>
                      <Link to={`/Detailhouse/${item._id}`}><img src={item.image} alt="" width='320' height={220} /></Link>
                    </div>
