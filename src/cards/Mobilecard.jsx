...
const Bikecard1 = () => {
  ...
  const filteredData=data?.filter((bikes)=>bikes.Category==="Mobile")
  return (
   <div className="m3">
    <div>
    <div class='d-flex'>
    ...
    <h4 id='heading1'>MOBILE PHONES IN PAKISTAN</h4>
    </div>
       <div class='d-flex'>
        <div class="m7">
  ...
  {filteredData?.map((item) => {
             ...
             return(
              <div class=' d-flex  mt-2 '>
               <div id='img0'>
               <Link to={`/Detailmobile/${item._id}`}><img src={item.image} alt="" width='320' height={220}/></Link>
               </div>
