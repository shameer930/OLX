...
console.log(data,"data from bike2")
  ...
  const filteredData=data?.filter((bikes)=>bikes.Category==="bike")
  ...
  {filteredData?.map((item) => {
             ...
             return(
              <div class=' d-flex  mt-2 '>
               <div id='img0'>
               <Link to={`/Detailbike/${item._id}`}><img src={item.image} alt="" width='320' height={220}/></Link>
               </div>
