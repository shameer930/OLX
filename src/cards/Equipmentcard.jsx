...
const Bikecard1 = () => {
  ...
  const filteredData=data?.filter((bikes)=>bikes.Category==="Equipment")
  return (
   <div className="m3">
    <div>
    <div class='d-flex'>
...
<div class='row'>
  <div className="col-lg-3 ">
    ...
    <div class="mt-3 m12">
     ...
     <p >All Categories</p>
     <p class='p11'>Electronics & Home Appliances</p>
     </div>
     <div class=' m13'>
      <p>Video Audio(237942)</p>
      <p>Radio(23566)</p>
      <p>Microphone(10088)</p>
      <p>Amplifier(5102)</p>
      <p>Soundbars(115)</p>
      <p>Speakers(118)</p>
      <p>Audio interface(5102)</p>
      <p>Digital Recoders(34)</p>
      <p>CD/DVD Players(20)</p>
     </div>
    </div>
    <div className="m7">
  ...
  {filteredData?.map((item) => {
             ...
             return(
              <div class=' d-flex  mt-2 '>
               <div id='img0'>
               <Link to={`/Detailequipment/${item._id}`}><img src={item.image} alt="" width='320' height={220}/></Link>
               </div>
